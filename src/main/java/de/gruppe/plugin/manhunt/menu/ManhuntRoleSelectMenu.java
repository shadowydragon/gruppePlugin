...
public class ManhuntRoleSelectMenu extends AbstractMenu {
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        if (event.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("hunter"))
        {
    ...
    public void setMenuItems(Player player) {
        ...
        noneMaterial.setDisplayName("None");
        ...
        huntMeta.setDisplayName("Hunter");
        ...
        speedrunnerMeta.setDisplayName("Speedrunner");
